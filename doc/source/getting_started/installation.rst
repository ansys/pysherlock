...
The below instructions are for Sherlock and PySherlock only. If you have other PyAnsys products, please see the `Ansys package <https://docs.pyansys.com/version/dev/getting-started/install.html>`_ which packages all the PyAnsys products into one Python package including PySherlock.
